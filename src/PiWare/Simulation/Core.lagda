...
open import PiWare.Circuit.Core Gt
    using (ℂ'; comb'; Combℂ'; cc'; Nil; Gate; Plug; DelayLoop; _|'_; _|+'_; _⟫'_; _Named_)
...
%<*eval-core>
\begin{code}
⟦_⟧' : {i o : ℕ} → (c : Combℂ' i o) → (W i → W o)
⟦ cc' Nil ⟧' = const ε
⟦ cc' (Gate g#) ⟧' = spec g#
⟦ cc' (Plug p) ⟧' = plugOutputs p
⟦ cc' (c Named _) ⟧' = ⟦ cc' c ⟧'
⟦ cc' (c₁ ⟫' c₂) ⦃ p₁ , p₂ ⦄ ⟧' = ⟦ cc' c₂ ⟧' ∘ ⟦ cc' c₁ ⟧'
⟦ cc' (_|'_  {i₁} c₁ c₂) ⦃ p₁ , p₂ ⦄ ⟧' = uncurry′ _++_ ∘ mapₚ (⟦ cc' c₁ ⟧') (⟦ cc' c₂ ⟧') ∘ splitAt' i₁
⟦ cc' (_|+'_ {i₁} c₁ c₂) ⦃ p₁ , p₂ ⦄ ⟧' = [ ⟦ cc' c₁ ⟧' , ⟦ cc' c₂ ⟧' ]′ ∘ untag {i₁}
⟦ cc' (DelayLoop c) ⦃ () ⦄ ⟧' v
\end{code}
%</eval-core>
...
%<*delay>
\begin{code}
delay : ∀ {i o l} (c : Combℂ' (i + l) (o + l)) → W i ⇒ᶜ W (o + l)
delay {i} {o} {l} c = uncurry⁺ (delay' {i} {o} {l} c)
  where
    delay' : ∀ {i o l} (c : Combℂ' (i + l) (o + l)) → W i → List (W i) → W (o + l)
