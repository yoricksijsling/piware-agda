...
%<*xor-proof-table>
\begin{code}
⊻ℂ-proof-table : ∀ a b → ⟦ cc ⊻ℂ ⦃ _ ⦄ ⟧ (a , b) ≡ ⊻ℂ-spec-table (a , b)
...
%<*xor-proof-subfunc>
\begin{code}
⊻ℂ-proof-subfunc : ∀ a b → ⟦ cc ⊻ℂ ⦃ _ ⦄ ⟧ (a , b) ≡ ⊻ℂ-spec-subfunc (a , b)
...
%<*proofHaddBool>
\begin{code}
proofHaddBool : ∀ a b → ⟦ cc hadd ⦃ _ ⦄ ⟧ (a , b) ≡ haddSpec a b
...
%<*proofFaddBool>
\begin{code}
proofFaddBool : ∀ a b c → ⟦ cc fadd ⦃ _ ⦄ ⟧ ((a , b) , c) ≡ faddSpec a b c
